...
var config = {
    ...
    // 默认菜单配置
    menus: ['head', 'bold', 'fontSize', 'fontName', 'italic', 'underline', 'strikeThrough', 'foreColor', 'backColor', 'link', 'list', 'justify', 'quote', 'emoticon', 'image', 'table', 'video', 'code', 'undo', 'redo', 'strokeColor'],
...
StrokeColor.prototype = {
    onClick: function onClick(e) {
        ...
        var isSeleEmpty = editor.selection.isSelectionEmpty();
        var selectionText = editor.selection.getSelectionText();
        var shadowCSSContent = 'text-shadow: 0px 0px 2px red,0px 0px 2px red';
        var strokText = void 0;
        if (!isSeleEmpty) {
            //选取元素非空
